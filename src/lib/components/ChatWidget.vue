    ...
    <div class="bot-containner"
      ...
      <div class="bot-input">
        ...
        <button @click="handleSubmit">
          <svg :style="{ fill: inputValue && inputValue.trim() !== '' && !isLoading ? '#666' : '#999' }" width="21" height="21" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <path
...
.bot-header { height: 70px; display: flex; padding-left: 20px; padding-right: 10px; align-items: center; justify-content: space-between; }
.bot-header .logo { line-height: 0; display: flex; align-items: center; }
.bot-header .logo img { width: 45px; border-radius: 50%; }
...
.bot-content .message-assistant .content { border-radius: 0 0.5rem 0.5rem 0.5rem; }
